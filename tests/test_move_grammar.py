"""Tests for the vendored tree-sitter-move grammar loader."""
...
from trailmark.tree_sitter_custom import move as move_mod
...
def _mock_so_exists(exists: bool) -> Any:
    ...
    return patch.object(move_mod, "_SO_PATH", fake_path)
...
class TestLanguage:
    ...
    def test_language_skips_build_if_exists(self) -> None:
        with patch.object(move_mod, "_build") as mock_build:
            move_mod.language()
